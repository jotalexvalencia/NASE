// ===================================================================
// 🗄️ limpieza_bimestral_respuestas.gs – Archivo Inteligente y Limpieza (NASE 2026)
// -------------------------------------------------------------------
/**
...
function instalarTriggersLimpiezaBimestralRespuestas() {
  ...
  Logger.log("✅ Trigger bimestral limpieza Respuestas instalado.");
}
